...
function Spark({ data, color = "var(--accent)", flat }: { data: number[]; color?: string; flat?: boolean }) {
  const w = 100, h = 22;
...
export default function Overview({ data, setRoute }: OverviewProps) {
  ...
  const sparks = {
    ...
    bus: [0.55, 0.55, 0.55, 0.55, 0.55, 0.55, 0.55],
  };
            ...
            <div className="card span-2">
              ...
              <div className="activity">
                ...
                <div className="act-row">
                  ...
                  <span>Linked T-019 ↔ D-002 (bus voltage choice)</span>
                </div>
              </div>
            </div>
