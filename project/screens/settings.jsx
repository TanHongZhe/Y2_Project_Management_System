// Settings — API key, temperature, theme, clear, export
const { useState: useStateSettings } = React;

function Settings({ tweaks, setTweak, data }) {
  const [apiKey, setApiKey] = useStateSettings("sk-or-v1-•••••••••••••••••••••••••••••••••••••••••••••");
  const [showKey, setShowKey] = useStateSettings(false);
  const [temp, setTemp] = useStateSettings(40);
  const [maxTokens, setMaxTokens] = useStateSettings(2048);
          ...
          <div className="settings-group">
            ...
            <div className="settings-row">
              ...
              <div className="range-row">
                <input type="range" className="range" min="0" max="100" value={temp} onChange={e => setTemp(+e.target.value)} />
            ...
            <div className="settings-row">
              ...
              <input className="input" type="number" value={maxTokens} onChange={e => setMaxTokens(+e.target.value)} style={{ width: 120 }} />
            </div>
          </div>
